...
rating_counts = dash_df['rating'].value_counts().sort_index()
...
genre_means = dash_df.groupby('primary_genre')['rating'].mean().sort_values(ascending=False).reset_index()
...
year_counts = dash_df['year'].value_counts().sort_index()
...
top_tags = dash_df['tag'].value_counts().head(10).reset_index()
...
# Section 6: Tag Frequency by Selected Genre
